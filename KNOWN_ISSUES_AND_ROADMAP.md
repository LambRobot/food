...
2. **Ground-truth calibration.** ⏳ *Still open.* Compare ~20 recipes against a reference (USDA "What's in the Foods You Eat" tool, Edamam free tier, or hand calculation). Quantify the real error band and **calibrate the confidence score** against it. *Turns "±10–25%, asserted" into "measured".* **← recommended next.**
